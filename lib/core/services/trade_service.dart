...
class TradeService{
  ...
  Future<ResponseModel> createDonationRequest(String offerData) async {
    try {
      ...
      if (e is Map<String, dynamic>) {
      ...
      } else if (e.toString().contains('Donation Request already exists')) {
        ...
        try {
          ...
          return ResponseModel(
              success: false, message: "Donation Request already exists");
        }
      } else {
